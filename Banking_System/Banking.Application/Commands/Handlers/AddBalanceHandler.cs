...
{
    public class AddBalanceHandler : ICommandHandler<AddBalance>
    {
        private readonly IUserRepository _userRepository;
        private readonly IBankAccountRepository _bankAccountRepository;

        public AddBalanceHandler(IUserRepository userRepository, IBankAccountRepository bankAccountRepository)
        {
            _userRepository = userRepository;
            _bankAccountRepository = bankAccountRepository;
        }

        public async Task HandleAsync(AddBalance command, CancellationToken cancellationToken = new CancellationToken())
        {
